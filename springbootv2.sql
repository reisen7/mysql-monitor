...
CREATE TABLE `t_mybatis_test`  (
  ...
  `titlex` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '标题',
  `ifabc` int NULL DEFAULT NULL COMMENT '是与否',
  `reatetime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `asdtime` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `fsv` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '副标题',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '自动生成测试' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_area`  (
  ...
  `area_code` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '区代码',
  `city_code` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '父级市代码',
  `area_name` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '市名称',
  ...
  `memo` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `data_state` int NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `Index_1`(`area_code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2013 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '地区设置' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_city`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增列',
  `city_code` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '市代码',
  `city_name` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '市名称',
  `short_name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '简称',
  `province_code` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '省代码',
  `lng` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '经度',
  `lat` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '纬度',
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  `gmt_create` datetime NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `data_state` int NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `Index_1`(`city_code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 256 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '城市设置' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_department`  (
  ...
  `leader` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '部门负责人',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '部门表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_dict_data`  (
  ...
  `css_class` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '样式属性（其他样式扩展）',
  `list_class` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '表格回显样式',
...
CREATE TABLE `t_sys_email`  (
  ...
  `receivers_email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '接收人电子邮件',
  `title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '邮件标题',
  `content` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL COMMENT '内容',
  `send_user_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '发送人id',
  `send_user_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '发送人账号',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '电子邮件' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_file`  (
  `id` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL COMMENT '主键',
  `file_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '文件名字',
  `bucket_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '桶名',
  `file_size` bigint NULL DEFAULT NULL COMMENT '文件大小',
  `file_suffix` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '后缀',
  `create_user_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '创建人id',
  `create_user_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '创建人名字',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_user_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '修改人',
  `update_user_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '修改人名字',
  `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '文件信息表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_file` VALUES ('581154436022407168', '581154436022407168.png', 'v2-cloud', 111022, 'image/png', '1', 'admin', '2021-07-30 18:27:05', NULL, NULL, NULL);
...
CREATE TABLE `t_sys_inter_url`  (
  `id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '主键',
  `inter_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '拦截名称',
  `url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '拦截url',
  `type` int NULL DEFAULT NULL COMMENT '类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '拦截url表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_notice`  (
  ...
  `content` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '内容',
  `type` int NULL DEFAULT NULL COMMENT '类型',
  `create_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建人id',
  `create_username` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '创建人name',
...
CREATE TABLE `t_sys_notice_user`  (
  `id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '主键',
  `notice_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '公告id',
  `user_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户id',
  `state` int NULL DEFAULT NULL COMMENT '0未阅读 1 阅读',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '公告_用户外键' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_oper_log`  (
  ...
  `method` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '方法',
  `oper_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '操作人',
  `oper_url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT 'url',
  `oper_param` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '参数',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '日志记录表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_oper_log` VALUES ('433236479515430912', '用户新增', 'com.fc.test.controller.admin.UserController.add()', 'admin', '/UserController/add', '{\"username\":[\"reisen\"],\"password\":[\"111111\"],\"nickname\":[\"reisen\"]}', NULL, '2020-06-17');
...
CREATE TABLE `t_sys_permission`  (
  ...
  `descripion` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '权限描述',
  `url` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '授权链接',
  `is_blank` int NULL DEFAULT 0 COMMENT '是否跳转 0 不跳转 1跳转',
  `pid` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '父节点id',
...
CREATE TABLE `t_sys_permission_role`  (
  ...
  `permission_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '权限id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色权限中间表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_permission_role
-- ----------------------------
INSERT INTO `t_sys_permission_role` VALUES ('066c5297-ba91-4160-b09a-ee6767ad1da1', '488243256161730560', '21');
INSERT INTO `t_sys_permission_role` VALUES ('0699e185-b1e8-46a6-8eed-3cbaf3e08354', '488243256161730560', '8');
INSERT INTO `t_sys_permission_role` VALUES ('085864e9-18ca-4ca6-9488-9b8050ed2a03', '488243256161730560', '6192095215075983364');
INSERT INTO `t_sys_permission_role` VALUES ('0859ec7d-f992-45f7-9e29-4e56bb2e4cb1', '488243256161730560', '331778807298134016');
INSERT INTO `t_sys_permission_role` VALUES ('0a063c21-13be-4932-b7d0-c087d81e7474', '488243256161730560', '3400681518049566753');
INSERT INTO `t_sys_permission_role` VALUES ('0c1e5b57-2a66-4a14-b6af-9a6df97f7c05', '488243256161730560', '574578311263555584');
INSERT INTO `t_sys_permission_role` VALUES ('10d38129-c270-4a84-af0e-400c27ca79a6', '488243256161730560', '6192095214866268162');
INSERT INTO `t_sys_permission_role` VALUES ('132bac5c-c9b1-4629-bb0a-29060a3d1049', '488243256161730560', '332857281479839744');
INSERT INTO `t_sys_permission_role` VALUES ('14ea15a6-6a1f-49a1-85d8-9a27b65c1ebe', '488243256161730560', '3303650266428252193');
INSERT INTO `t_sys_permission_role` VALUES ('1caf4550-69fd-422c-a4f8-0e61586f03c8', '488243256161730560', '3400961831355064364');
INSERT INTO `t_sys_permission_role` VALUES ('1d59b35e-804c-428c-aa63-a2ba6022c1e8', '488243256161730560', '340127412270534656');
INSERT INTO `t_sys_permission_role` VALUES ('1db6579e-ccb0-4f1c-b058-7865bf3ec346', '488243256161730560', '4109898056992071691');
INSERT INTO `t_sys_permission_role` VALUES ('1eceff30-6371-428c-aad1-536cb0a37370', '488243256161730560', '332157860920299520');
INSERT INTO `t_sys_permission_role` VALUES ('21061acb-39d3-49d4-b2db-8119d4b8f169', '488243256161730560', '6189186317989969924');
INSERT INTO `t_sys_permission_role` VALUES ('211085dc-62aa-4ada-9215-772f9591838d', '488243256161730560', '12');
INSERT INTO `t_sys_permission_role` VALUES ('21116afa-e48a-4c64-be9e-8c2ce2a6bdbd', '488243256161730560', '3734899074291507211');
INSERT INTO `t_sys_permission_role` VALUES ('218752dd-1abc-4f92-b1a7-3ef1eba4461d', '488243256161730560', '3400681518049566742');
INSERT INTO `t_sys_permission_role` VALUES ('23352ed2-05de-4fbc-ace6-d13e2a82c026', '488243256161730560', '3400681518049566764');
INSERT INTO `t_sys_permission_role` VALUES ('2385d66c-eb75-4980-96be-25ee1ab5df2f', '488243256161730560', '574578311267749889');
INSERT INTO `t_sys_permission_role` VALUES ('24658a48-fb9e-40bb-b14c-b4a74ee473fe', '488243256161730560', '410989805699207168');
INSERT INTO `t_sys_permission_role` VALUES ('25264d7b-c203-4edc-a231-5becb4fbc81e', '488243256161730560', '4107917018594058262');
INSERT INTO `t_sys_permission_role` VALUES ('33064ec5-152e-4669-940d-88c24ae20ccf', '488243256161730560', '3328572814798397451');
INSERT INTO `t_sys_permission_role` VALUES ('33c4cd38-1cbd-488a-9766-119e9e3274f2', '488243256161730560', '11');
INSERT INTO `t_sys_permission_role` VALUES ('3b6dd3ba-10a2-4908-b0ac-c05886b3a735', '488243256161730560', '13');
INSERT INTO `t_sys_permission_role` VALUES ('3deddf92-fbd5-44af-9e5d-7c623e068ad4', '488243256161730560', '574578311267749890');
INSERT INTO `t_sys_permission_role` VALUES ('3ec0e1d5-b519-4767-ade7-203f10bdf708', '488243256161730560', '3400880220181667873');
INSERT INTO `t_sys_permission_role` VALUES ('3fc18817-593b-4b86-9841-c10fdb0b747e', '488243256161730560', '411522822607867904');
INSERT INTO `t_sys_permission_role` VALUES ('40e91cff-3299-41a2-ac96-2905706ad097', '488243256161730560', '4107917018594058273');
INSERT INTO `t_sys_permission_role` VALUES ('423e478d-c88e-47fc-8b13-544173af5a22', '488243256161730560', '3400961831355064342');
INSERT INTO `t_sys_permission_role` VALUES ('425e256e-dd22-448b-be25-f71f6cf779bb', '488243256161730560', '6192095215075983363');
INSERT INTO `t_sys_permission_role` VALUES ('49a3e53e-2176-4379-ba28-e11cf232c105', '488243256161730560', '496127240363311104');
INSERT INTO `t_sys_permission_role` VALUES ('4a9f6a2d-cf7a-4c29-b905-05fe68a28ce6', '488243256161730560', '6189186317948026883');
INSERT INTO `t_sys_permission_role` VALUES ('4f790ff7-d059-40cd-b5ef-2c4e76b86fc9', '488243256161730560', '6189186317738311681');
INSERT INTO `t_sys_permission_role` VALUES ('4f959f8a-b7bc-4429-8aec-7630ea800dff', '488243256161730560', '610635950447394816');
INSERT INTO `t_sys_permission_role` VALUES ('50990fe8-2028-4c82-87c9-43fdd81d176a', '488243256161730560', '486690002869157888');
INSERT INTO `t_sys_permission_role` VALUES ('50fa396d-f94d-4c74-b1dc-49bf6b067fe8', '488243256161730560', '3400961831355064331');
INSERT INTO `t_sys_permission_role` VALUES ('5593f711-4bb2-4b94-aded-61981da25fdf', '488243256161730560', '3401274122705346593');
INSERT INTO `t_sys_permission_role` VALUES ('57b43761-af6c-4f5a-b3f9-0a83fbbb5b7f', '488243256161730560', '23');
INSERT INTO `t_sys_permission_role` VALUES ('5ce365db-298f-4fdc-b5d5-e4482639f15a', '488243256161730560', '14');
INSERT INTO `t_sys_permission_role` VALUES ('5d8fa002-0f90-4126-9d87-95c3c1706e2e', '488243256161730560', '3303650266428252171');
INSERT INTO `t_sys_permission_role` VALUES ('5ecdc42d-0f8d-4830-88b9-9860eb28f43b', '488243256161730560', '3734899074291507222');
INSERT INTO `t_sys_permission_role` VALUES ('6114d268-a965-4b69-9a38-a3db85792c19', '488243256161730560', '5946910264304599043');
INSERT INTO `t_sys_permission_role` VALUES ('614eb36b-0669-4d57-8b19-3d704ee3a7d6', '488243256161730560', '3400961831355064353');
INSERT INTO `t_sys_permission_role` VALUES ('63799b36-31f6-4c79-91c1-dce461db0e52', '488243256161730560', '9');
INSERT INTO `t_sys_permission_role` VALUES ('645a7654-a989-44c8-a716-25c6b8f3c116', '488243256161730560', '3321578609202995233');
INSERT INTO `t_sys_permission_role` VALUES ('68231e49-111e-4d21-9292-7c615b50996a', '488243256161730560', '16');
INSERT INTO `t_sys_permission_role` VALUES ('68b96107-2324-4d85-b51f-bed1d81e44cc', '488243256161730560', '10');
INSERT INTO `t_sys_permission_role` VALUES ('6a06f643-9fe7-465a-8816-05df28cf9067', '488243256161730560', '5946910264304599042');
INSERT INTO `t_sys_permission_role` VALUES ('700070b4-dda0-4069-8d7c-525643b991f5', '488243256161730560', '373489907429150720');
INSERT INTO `t_sys_permission_role` VALUES ('75ee048e-5d63-4f85-ba8d-f5f0ecc6a33b', '488243256161730560', '3734899074291507244');
INSERT INTO `t_sys_permission_role` VALUES ('7b996786-9ca8-4f80-93b2-b677fce8eb8f', '488243256161730560', '4107917018594058251');
INSERT INTO `t_sys_permission_role` VALUES ('7fd28448-ad14-40b2-8a8c-2776c0a318b2', '488243256161730560', '574578311267749888');
INSERT INTO `t_sys_permission_role` VALUES ('806cd566-83fb-4d54-8d90-e8a4a3e8ce35', '488243256161730560', '496127794879660032');
INSERT INTO `t_sys_permission_role` VALUES ('84cddee1-8af2-419e-9ce7-4ec3add8bc02', '488243256161730560', '592067570522128384');
INSERT INTO `t_sys_permission_role` VALUES ('84ec1d8f-9d90-42bb-a2b6-407a415aa4b5', '488243256161730560', '4107917018594058284');
INSERT INTO `t_sys_permission_role` VALUES ('8733ee6b-7334-4f95-a224-ce96143f3261', '488243256161730560', '4109898056992071702');
INSERT INTO `t_sys_permission_role` VALUES ('87371786-7bad-48cd-a532-e3e3f654f86f', '488243256161730560', '5');
INSERT INTO `t_sys_permission_role` VALUES ('887a541d-58a0-4a71-950a-e9e871538aff', '488243256161730560', '3400880220181667862');
INSERT INTO `t_sys_permission_role` VALUES ('88c46d01-aa27-4bd5-b9d0-9a3faa08beab', '488243256161730560', '586003694080753664');
INSERT INTO `t_sys_permission_role` VALUES ('89f840d7-2f97-4bc0-9b02-cc454b8a44d0', '488243256161730560', '617766548966211584');
INSERT INTO `t_sys_permission_role` VALUES ('8a4c8ea3-5f5e-4ea8-8073-0f28122542d5', '488243256161730560', '592059865673760768');
INSERT INTO `t_sys_permission_role` VALUES ('8a920673-b16a-4dd5-96e6-7ae73ac0c0cb', '488243256161730560', '340096183135506432');
INSERT INTO `t_sys_permission_role` VALUES ('8cb881c2-4f3f-4ba8-b2ff-228ef5b984bb', '488243256161730560', '3400681518049566731');
INSERT INTO `t_sys_permission_role` VALUES ('913c2e23-cbba-4011-80dc-682ed89ce39f', '488243256161730560', '17');
INSERT INTO `t_sys_permission_role` VALUES ('91a59c4a-06c5-452d-8a9c-92a4f601b5f1', '488243256161730560', '592167738407911424');
INSERT INTO `t_sys_permission_role` VALUES ('9c9f4586-3e55-4fd0-a536-fed2c39f404d', '488243256161730560', '410791701859405824');
INSERT INTO `t_sys_permission_role` VALUES ('9e6dc666-9bc1-4714-b0c4-2505c79509ea', '488243256161730560', '3401274122705346571');
INSERT INTO `t_sys_permission_role` VALUES ('9fc15dce-fc46-44f7-ac00-743fc4bb2a0f', '488243256161730560', '3303650266428252182');
INSERT INTO `t_sys_permission_role` VALUES ('a065c81d-7d65-4b67-934d-c4989d6f8d2b', '488243256161730560', '20');
INSERT INTO `t_sys_permission_role` VALUES ('a2adb00d-b302-4066-b90f-1ffafbce39a5', '488243256161730560', '22');
INSERT INTO `t_sys_permission_role` VALUES ('a2d0e35b-da11-4421-a01b-387f1a29a3fa', '488243256161730560', '335330315113467904');
INSERT INTO `t_sys_permission_role` VALUES ('a8879e80-f916-4bde-9f6c-df0d67d51879', '488243256161730560', '7');
INSERT INTO `t_sys_permission_role` VALUES ('ac123569-dc08-4bc8-ab86-263f4aa4f19c', '488243256161730560', '589559748521623552');
INSERT INTO `t_sys_permission_role` VALUES ('af10b996-1c2b-42cb-918d-4945bdf27c5b', '488243256161730560', '340067579836108800');
INSERT INTO `t_sys_permission_role` VALUES ('b44c6420-35ba-4ecd-b17d-a229ece1acb9', '488243256161730560', '618918631769636864');
INSERT INTO `t_sys_permission_role` VALUES ('b4df8fed-2b12-492d-9b7b-fe123fda1dab', '488243256161730560', '6');
INSERT INTO `t_sys_permission_role` VALUES ('b70aa162-de60-4883-9679-f886a6ecc6e5', '488243256161730560', '3734899074291507233');
INSERT INTO `t_sys_permission_role` VALUES ('ba6a81c7-bf61-4e9c-b738-eeecc0da655c', '488243256161730560', '4109898056992071713');
INSERT INTO `t_sys_permission_role` VALUES ('baa53faa-0e29-4c55-8ff9-fe5a938cb2f0', '488243256161730560', '4109898056992071724');
INSERT INTO `t_sys_permission_role` VALUES ('bd222db6-28b3-4bb8-b518-4dbb88030e8f', '488243256161730560', '619836559427895296');
INSERT INTO `t_sys_permission_role` VALUES ('bdcba55c-a5df-488f-9b55-df21c4c34fcb', '488243256161730560', '19');
INSERT INTO `t_sys_permission_role` VALUES ('bfa41283-9582-438e-8bf3-3222d569ccac', '488243256161730560', '340381240911859712');
INSERT INTO `t_sys_permission_role` VALUES ('c0b00222-c1b9-421f-b17b-5a890da8c712', '488243256161730560', '3400880220181667884');
INSERT INTO `t_sys_permission_role` VALUES ('c4c4f17e-89c6-4993-9643-6d5d6d33bc97', '488243256161730560', '6192095214866268161');
INSERT INTO `t_sys_permission_role` VALUES ('c7cc037e-cf5b-4f48-a3d6-90f95bcafd2c', '488243256161730560', '610635485890478080');
INSERT INTO `t_sys_permission_role` VALUES ('cadddbad-1328-4e78-9173-eec0134d476c', '488243256161730560', '594691026430459904');
INSERT INTO `t_sys_permission_role` VALUES ('cf59fac9-b907-4c28-af1c-20a4de5d2b9a', '488243256161730560', '6189186317948026882');
INSERT INTO `t_sys_permission_role` VALUES ('d1b03198-9a0b-44e4-8e15-838db9ac46c0', '488243256161730560', '5946910264304599044');
INSERT INTO `t_sys_permission_role` VALUES ('d27bdc95-9591-4ac3-b286-bdface6d1456', '488243256161730560', '15');
INSERT INTO `t_sys_permission_role` VALUES ('d3acc6d1-f7a3-4c6f-ad6f-3d1cb44c270b', '488243256161730560', '4');
INSERT INTO `t_sys_permission_role` VALUES ('d4f334d3-3186-4959-9352-622438bf2da7', '488243256161730560', '581541547099553792');
INSERT INTO `t_sys_permission_role` VALUES ('d502c055-b412-4c6f-877b-20dacd81a249', '488243256161730560', '340088022018166784');
INSERT INTO `t_sys_permission_role` VALUES ('d9273ce1-2b2d-4c54-a570-d06f63a3afd7', '488243256161730560', '18');
INSERT INTO `t_sys_permission_role` VALUES ('d9e8ff1f-a488-439b-b879-552b9c6250d2', '488243256161730560', '496126970468237312');
INSERT INTO `t_sys_permission_role` VALUES ('def86234-f159-4ec7-b931-d16e3518470a', '488243256161730560', '3328572814798397473');
INSERT INTO `t_sys_permission_role` VALUES ('e082c329-cd34-404f-8554-c1df549fe8b9', '488243256161730560', '340301160042860544');
INSERT INTO `t_sys_permission_role` VALUES ('e5335f29-b5b4-4201-b2fc-d4cd84c8a10c', '488243256161730560', '3321578609202995211');
INSERT INTO `t_sys_permission_role` VALUES ('e59a1cea-6c1f-4d19-89d8-4fda3f422e83', '488243256161730560', '583063272123531264');
INSERT INTO `t_sys_permission_role` VALUES ('e63fb73e-cb40-4ded-b0dd-dbd793f2449c', '488243256161730560', '3401274122705346604');
INSERT INTO `t_sys_permission_role` VALUES ('e664da53-9c34-4af8-bc6c-13e7037fe62c', '488243256161730560', '3401274122705346582');
INSERT INTO `t_sys_permission_role` VALUES ('e7560366-95d5-4d7a-8441-03ff73db310e', '488243256161730560', '574578311267749891');
INSERT INTO `t_sys_permission_role` VALUES ('ebc51f34-b0b0-4d2b-98b5-68c0610a2bee', '488243256161730560', '5946910264304599041');
INSERT INTO `t_sys_permission_role` VALUES ('f1663132-5b2a-43a3-a2d3-f6fe34083397', '488243256161730560', '587453033487532032');
INSERT INTO `t_sys_permission_role` VALUES ('f21d7d63-6fff-43b5-abb6-3b223a62b535', '488243256161730560', '330365026642825216');
INSERT INTO `t_sys_permission_role` VALUES ('f2734967-d871-4cce-b128-8693827c347a', '488243256161730560', '340068151804956672');
INSERT INTO `t_sys_permission_role` VALUES ('f28eec36-bb50-427b-b754-a31f6fef10e9', '488243256161730560', '3400880220181667851');
INSERT INTO `t_sys_permission_role` VALUES ('f82bb430-5903-4ea6-aede-3a9aedf5b8f5', '488243256161730560', '3321578609202995244');
INSERT INTO `t_sys_permission_role` VALUES ('fc491d19-2f48-4bfb-a919-9591587d874e', '488243256161730560', '3303650266428252204');
INSERT INTO `t_sys_permission_role` VALUES ('fd49bdfc-9d06-4711-b1a0-738d6e8ac04e', '488243256161730560', '3321578609202995222');
...
CREATE TABLE `t_sys_position`  (
  ...
  `status` int NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '岗位表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_province`  (
  ...
  `data_state` int NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `Index_1`(`province_code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '省份表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_quartz_job`  (
  ...
  `job_group` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '任务组名',
  `invoke_target` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '调用目标字符串',
  `cron_expression` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'cron执行表达式',
  `misfire_policy` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'cron计划策略',
  `concurrent` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否并发执行（0允许 1禁止）',
...
CREATE TABLE `t_sys_quartz_job_log`  (
  ...
  `job_group` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '任务组名',
  `invoke_target` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '调用目标字符串',
  `job_message` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '日志信息',
  `status` int NULL DEFAULT NULL COMMENT '执行状态（0正常 1失败）',
  `exception_info` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '异常信息',
...
CREATE TABLE `t_sys_role_user`  (
  ...
  `sys_user_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '用户id',
  `sys_role_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户角色中间表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_street`  (
  ...
  `area_code` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '父级区代码',
  ...
  `data_state` int NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `Index_1`(`street_code` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '街道设置' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_sys_user`  (
  ...
  `pos_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '岗位id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_user
-- ----------------------------
INSERT INTO `t_sys_user` VALUES ('1', 'admin', '21232f297a57a5a743894a0e4a801fc3', '管理员', 2, '410792368778907648');
INSERT INTO `t_sys_user` VALUES ('433236479427350528', 'reisen', '21232f297a57a5a743894a0e4a801fc3', '付册', 2, '410792443127140352');
...
CREATE TABLE `t_test`  (
  ...
  `t_cb_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '写个字符串',
  PRIMARY KEY (`id`) USING BTREE
