 ...
 *
 */
public class UpdateMysqlStatus
{
    // 定义Logger
    ...
    // 数据库操作服务
    protected JdbcService jdbcService = SpringUtils.getBean(JdbcService.class);
...
//    }
    ...
    // MySQL服务器Mapper
    protected MonitorServerMapper monitorServerMapper = SpringUtils.getBean(MonitorServerMapper.class);

    public UpdateMysqlStatus()
    {
